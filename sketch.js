...
function preload(){
  ...
  survivor_running = loadAnimation("survivor.png","survivor1.png","survivor3.png");
  survivor_collided = loadAnimation("survivor_collided.png");
...
function setup() {
  ...
  survivor.setCollider('circle',0,0,350)
  survivor.scale = 0.08
  // trex.debug=true
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if((touches.length > 0 || keyDown("SPACE")) && survivor.y  >= height-120) {
      jumpSound.play( )
      survivor.velocityY = -10;
       touches = [];
    }
